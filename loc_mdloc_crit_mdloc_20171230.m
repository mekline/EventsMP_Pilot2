...
outputdir = '/mindhive/evlab/u/mekline/Documents/Projects/EventsMP_Pilot2/loc_mdloc_crit_mdloc_20171230/';
...
ss=struct(...
    ...
    'EffectOfInterest_contrasts', {{'H','E','H-E'}},...    % contrasts of interest; here you just indicate t
    'Localizer_contrasts',{{'H-E'}},...                     % localizer contrast 
    ...
    'ManualROIs','/users/evelina9/fMRI_PROJECTS/ROIS/MDfROIs_v3.img',... % predefined, this is the one we usually use, ask beforehand
